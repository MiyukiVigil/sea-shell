...
ShellRoot {
    ...
    function apply() {
        ...
        cartImg.source = root.bigStillFor(root.item).length
                       ? "file://" + root.bigStillFor(root.item) : "";
    ...
    Timer { id: hold; repeat: false; onTriggered: Qt.quit() }
    ...
    PanelWindow {
                    ...
                    Rectangle {
                        ...
                        Image {
                            ...
                            source: root.stillFor(frame.modelData).length
                                    ? "file://" + root.stillFor(frame.modelData) : ""
                            fillMode: Image.PreserveAspectCrop
        ...
        Item {
            ...
            Keys.onPressed: (e) => {
                ...
                case Qt.Key_Escape:    if (!root.clearQuery()) Qt.quit(); e.accepted = true; return;
        ...
        MouseArea {
            ...
            z: -1
            onClicked: if (!root.committing) Qt.quit()
        }
    }
